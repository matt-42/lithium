...
struct http_response {
  ...
  void write(http_response* r, const std::string res) const { r->body = res; }
  ...
  void write(http_response* r, const std::string_view res) const {
    r->body = std::string(res.data(), res.size());
  }

  void write(http_response* r, const char* res) const { r->body = res; }
